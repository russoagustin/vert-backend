...
public interface ProductoRepository extends JpaRepository<Producto, Integer> {
    ...
    /**
     * Procedimiento almacenado que crea un nuevo producto asociado a una categoría y subcategoría.
     */
    ...
    List<Producto> findAllByCategoriaId(@Param("idCategoria") Integer idCategoria);

    @Query("SELECT p FROM Producto p WHERE p.subCategoria.id = :idSubCategoria AND p.subCategoria.categoria.id = :idCategoria")
    List<Producto> findAllBySubCategoriaIdAndCategoriaId(
